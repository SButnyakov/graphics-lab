...
ground_verticies = ((1, 15, 2.5), (-1, 15, 2.5),
                    (-1, 15, 0.5), (1, 15, 0.5))
...
class Particle:
    ...
    def handle_collision(self):
        if -1 <= self.position[0] <= 1 and 15 > self.position[1] > 14.9 and 0.5 <= self.position[2] <= 2.5:
            self.velocity[0] = 0
            self.velocity[1] = 0
            self.velocity[2] = 0
        elif 0 <= self.position[0] <= 2 and 15 > self.position[1] > 10 and -2 <= self.position[2] <= 2:
            self.velocity[0] = 1
            self.velocity[1] = -6
            self.velocity[2] = -2
            ...
            self.track_size = random.randint(10, 40)
            self.is_handle = True
        elif -2 <= self.position[0] <= 0 and 15 > self.position[1] > 10 and -2 <= self.position[2] <= 2:
            self.velocity[0] = -1
            self.velocity[1] = -6
            self.velocity[2] = -2
            self.track[1] = [self.position[0], self.position[1], self.position[2]]
            self.track_size = random.randint(10, 40)
            self.is_handle = True
        elif 0 <= self.position[0] <= 2 and 15 > self.position[1] > 10 and 2 <= self.position[2] <= 4:
            self.velocity[0] = 1
            self.velocity[1] = -6
            self.velocity[2] = 1.5
            self.track[1] = [self.position[0], self.position[1], self.position[2]]
            self.track_size = random.randint(10, 40)
            self.is_handle = True
        elif -2 <= self.position[0] <= 0 and 15 > self.position[1] > 10 and 2 <= self.position[2] <= 4:
            self.velocity[0] = -1
            self.velocity[1] = -6
            self.velocity[2] = 1.5
            self.track[1] = [self.position[0], self.position[1], self.position[2]]
